...
async def task_2() -> Dict[str, Any]:
    """
    Task 2: Retrieve the market price data from the last 10 days
    Agent: market_data_agent
    """
    logger.info(f"Starting task 2: Retrieve the market price data from the last 10 da...")
    try:
...
async def task_4() -> Dict[str, Any]:
    """
    Task 4: Compare the predictions for the end of the federal shutdown with the changes in market price data
    Agent: reasoning_agent
    """
    logger.info(f"Starting task 4: Compare the predictions for the end of the federal...")
    try:
        agent = ReasoningAgent()
        output_path = agent.run(query="compare the predictions for the end of the federal shutdown with the changes in market price data", session_id=None)
