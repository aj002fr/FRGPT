...
async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Retrieve all polymarket data related to 'Trump'
    Agent: polymarket_agent
    """
    task_id = "task_2"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve all polymarket data related to 'Trump'...")
    ...
    try:
        ...
        output_path = agent.run(query="retrieve all polymarket data related to \'trump\'", session_id=None, limit=10)
