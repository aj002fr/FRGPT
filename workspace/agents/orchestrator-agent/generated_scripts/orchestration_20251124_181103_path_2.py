...
# Configuration
RUN_ID = "20251124_181103"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Retrieve the historical market data for Bitcoin for the past 30 days
    Agent: market_data_agent
    """
    task_id = "task_2"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve the historical market data for Bitcoin fo...")
