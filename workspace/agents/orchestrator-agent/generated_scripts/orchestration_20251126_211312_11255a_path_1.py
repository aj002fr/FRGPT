...
async def task_task_1() -> Dict[str, Any]:
    ...
    logger.info(f"Using tools: search_polymarket_with_history")
    ...
    try:
        ...
        # Call tool: search_polymarket_with_history
        logger.info(f"Calling tool: search_polymarket_with_history")
        tool_func = get_tool("search_polymarket_with_history")
        if tool_func is None:
            raise Exception(f"Tool not found: search_polymarket_with_history")
        
        tool_params_search_polymarket_with_history = {'query': 'bitcoin prediction 2025', 'limit': None, 'session_id': None}
        result_search_polymarket_with_history = tool_func(**tool_params_search_polymarket_with_history)
        tool_results["search_polymarket_with_history"] = result_search_polymarket_with_history
        logger.info(f"Tool search_polymarket_with_history completed")
