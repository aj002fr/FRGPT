...
async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve the most recent Bitcoin market data
    Agent: market_data_agent
    """
    task_id = "task_1"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve the most recent Bitcoin market data...")
    ...
    try:
        ...
        output_path = agent.run(template="by_symbol", params={'symbol_pattern': '%BTC%'}, columns=None, limit=1, order_by_column="file_date", order_by_direction="DESC")
