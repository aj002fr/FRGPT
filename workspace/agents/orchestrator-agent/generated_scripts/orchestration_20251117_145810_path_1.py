...
# Configuration
RUN_ID = "20251117_145810"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve all ZN treasury futures data from the database
    Agent: market_data_agent
    """
    task_id = "task_1"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve all ZN treasury futures data from the dat...")
    ...
    try:
        ...
        output_path = agent.run(template="by_symbol", params={'symbol_pattern': '%ZN%'}, columns=None, limit=1000, order_by_column=None, order_by_direction="ASC")
