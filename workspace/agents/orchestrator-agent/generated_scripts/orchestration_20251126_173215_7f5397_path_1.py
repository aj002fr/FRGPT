...
async def task_task_1() -> Dict[str, Any]:
    ...
    try:
        ...
        tool_params_run_query = {'template': 'by_symbol_and_date', 'params': {'symbol_pattern': '%BTC%', 'file_date': {'$gte': '2022-01-01', '$lte': '2025-12-31'}}, 'columns': ['close_price'], 'limit': None, 'order_by_column': 'file_date', 'order_by_direction': 'ASC'}
