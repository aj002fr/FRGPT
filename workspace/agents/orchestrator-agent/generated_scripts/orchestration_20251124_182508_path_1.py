...
# Configuration
RUN_ID = "20251124_182508"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve current prediction market states and trends for Bitcoin from Polymarket
    Agent: polymarket_agent
    """
    task_id = "task_1"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve current prediction market states and tren...")
    ...
    try:
        ...
        output_path = agent.run(query="retrieve current prediction market states and trends for bitcoin from polymarket", session_id=None, limit=10)
...
async def task_task_3() -> Dict[str, Any]:
    """
    Task task_3: Analyze the historical market data and prediction market data to make a prediction for Bitcoin in 2025
    Agent: polymarket_agent
    """
    task_id = "task_3"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Analyze the historical market data and prediction ...")
    ...
    try:
        # Execute agent
        agent = PolymarketAgent()
        output_path = agent.run(query="analyze the historical market data and prediction market data to make a prediction for bitcoin in 2025", session_id=None, limit=10)
