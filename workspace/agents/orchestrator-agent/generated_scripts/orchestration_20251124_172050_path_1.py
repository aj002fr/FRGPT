...
async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Query Polymarket for predictions about Bitcoin in 2025
    Agent: polymarket_agent
    """
    task_id = "task_1"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Query Polymarket for predictions about Bitcoin in ...")
    ...
    try:
        ...
        output_path = agent.run(query="query polymarket for predictions about bitcoin in 2025", session_id=None, limit=10)
