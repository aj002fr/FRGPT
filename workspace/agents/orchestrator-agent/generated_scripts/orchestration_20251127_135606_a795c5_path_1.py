...
async def task_task_1() -> Dict[str, Any]:
    ...
    try:
        ...
        tool_params_run_query = {'template': 'by_symbol_and_date', 'params': {'symbol_pattern': '%BTC%', 'start_date': '2022-01-01', 'end_date': '2022-12-31'}, 'columns': ['close'], 'limit': 1000, 'order_by_column': 'file_date', 'order_by_direction': 'DESC'}
