...
async def task_task_1() -> Dict[str, Any]:
    ...
    logger.info(f"Starting task {task_id}: Retrieve top polymarket predictions...")
    ...
    try:
        ...
        tool_params_search_polymarket_markets = {'query': 'top predictions', 'session_id': None, 'limit': None}
