...
async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve market data for the month of December
    Agent: market_data_agent
    """
    task_id = "task_1"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve market data for the month of December...")
...
async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Analyze the market data to identify any significant changes or trends during December
    Agent: market_data_agent
    """
    task_id = "task_2"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Analyze the market data to identify any significan...")
