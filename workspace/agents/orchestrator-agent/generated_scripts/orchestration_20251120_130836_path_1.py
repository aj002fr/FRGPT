...
# Configuration
RUN_ID = "20251120_130836"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Find the most recent date when ZN price was below 112
    Agent: market_data_agent
    """
    task_id = "task_1"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Find the most recent date when ZN price was below ...")
...
async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Retrieve the chance of nuclear war in 2025 on the date found in task 1
    ...
    try:
        ...
        output_path = agent.run(query="retrieve the chance of nuclear war in 2025 on the date found in task 1", session_id=None, limit=10)
