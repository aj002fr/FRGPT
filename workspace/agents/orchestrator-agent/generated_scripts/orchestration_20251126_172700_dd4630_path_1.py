...
async def task_task_1() -> Dict[str, Any]:
    ...
    logger.info(f"Starting task {task_id}: Retrieve top predictions from Polymarket...")
    ...
    try:
        ...
        tool_params_search_polymarket_markets = {
