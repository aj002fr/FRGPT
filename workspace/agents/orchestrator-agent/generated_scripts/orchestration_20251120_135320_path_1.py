...
# Configuration
RUN_ID = "20251120_135320"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve the last date when ZN was below 112.
    Agent: market_data_agent
    """
    task_id = "task_1"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve the last date when ZN was below 112....")
    ...
    try:
        ...
        output_path = agent.run(template="by_symbol", params={'symbol_pattern': '%ZN%'}, columns=None, limit=1000, order_by_column="file_date", order_by_direction="ASC")
...
async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Retrieve the chance of nuclear war in 2025 on the date when ZN was last below 112.
    Agent: polymarket_agent
    """
    task_id = "task_2"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve the chance of nuclear war in 2025 on the ...")
    ...
    try:
        ...
        output_path = agent.run(query="retrieve the chance of nuclear war in 2025 on the date when zn was last below 112.", session_id=None, limit=10)
