...
async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve Bitcoin price data
    ...
    logger.info(f"Starting task {task_id}: Retrieve Bitcoin price data...")
    ...
    try:
        ...
        tool_params_run_query = {'template': 'by_symbol_and_date', 'params': {'symbol_pattern': '%BTC%', 'file_date_start': '2021-01-01', 'file_date_end': '2022-12-31'}, 'columns': ['close'], 'limit': None, 'order_by_column': 'file_date', 'order_by_direction': 'ASC'}
