...
async def task_task_3() -> Dict[str, Any]:
    """
    Task task_3: Query the Polymarket prediction markets for Bitcoin
    Agent: polymarket_agent
    """
    task_id = "task_3"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Query the Polymarket prediction markets for Bitcoi...")
    ...
    try:
        ...
        output_path = agent.run(query="query the polymarket prediction markets for bitcoin", session_id=None, limit=10)
