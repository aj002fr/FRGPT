...
# Configuration
RUN_ID = "20251117_195105"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Get information from prediction markets about the expected Fed decision in December
    Agent: polymarket_agent
    """
    task_id = "task_2"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Get information from prediction markets about the ...")
    ...
    try:
        ...
        output_path = agent.run(query="get information from prediction markets about the expected fed decision in december", session_id=None, limit=10)
...
async def task_task_3() -> Dict[str, Any]:
    """
    Task task_3: Analyze and compare the data from market_data_agent and polymarket_agent to provide a comprehensive view of the expected Fed decision in December
    Agent: reasoning_agent
    """
    task_id = "task_3"
    agent_name = "reasoning_agent"
    
    logger.info(f"Starting task {task_id}: Analyze and compare the data from market_data_agen...")
    ...
    try:
        ...
        output_path = agent.run(query="analyze and compare the data from market_data_agent and polymarket_agent to provide a comprehensive view of the expected fed decision in december", session_id=None)
