...
# Configuration
RUN_ID = "20251117_144119"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Fetch the current predictions for Bitcoin from the prediction market
    Agent: polymarket_agent
    """
    task_id = "task_2"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Fetch the current predictions for Bitcoin from the...")
    ...
    try:
        ...
        output_path = agent.run(query="fetch the current predictions for bitcoin from the prediction market", session_id=None, limit=10)
...
async def task_task_3() -> Dict[str, Any]:
    """
    Task task_3: Compare and analyze the market data and prediction market data to provide a comprehensive view of current Bitcoin predictions
    Agent: reasoning_agent
    """
    task_id = "task_3"
    agent_name = "reasoning_agent"
    
    logger.info(f"Starting task {task_id}: Compare and analyze the market data and prediction...")
    ...
    try:
        ...
        output_path = agent.run(query="compare and analyze the market data and prediction market data to provide a comprehensive view of current bitcoin predictions", session_id=None)
