...
# Configuration
RUN_ID = "20251117_160217"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve the most recent market data related to federal interest rates
    Agent: market_data_agent
    """
    task_id = "task_1"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve the most recent market data related to fe...")
...
async def task_task_3() -> Dict[str, Any]:
    """
    Task task_3: Analyze and compare the data from the market data and Polymarket to estimate the chance of fed cuts in December
    Agent: reasoning_agent
    """
    task_id = "task_3"
    agent_name = "reasoning_agent"
    
    logger.info(f"Starting task {task_id}: Analyze and compare the data from the market data ...")
    ...
    try:
        ...
        output_path = agent.run(query="analyze and compare the data from the market data and polymarket to estimate the chance of fed cuts in december", session_id=None)
