...
# Configuration
RUN_ID = "20251119_183611"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Find the most recent date when the price of ZN was below 112
    Agent: market_data_agent
    """
    task_id = "task_1"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Find the most recent date when the price of ZN was...")
    ...
    try:
        ...
        output_path = agent.run(template="by_symbol", params={'symbol_pattern': '%ZN%'}, columns=None, limit=1, order_by_column="file_date", order_by_direction="DESC")
...
async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Find the chance of nuclear war in 2025 on the date found in task 1
    Agent: polymarket_agent
    """
    task_id = "task_2"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Find the chance of nuclear war in 2025 on the date...")
    ...
    try:
        ...
        output_path = agent.run(query="find the chance of nuclear war in 2025 on the date found in task 1", session_id=None, limit=10)
