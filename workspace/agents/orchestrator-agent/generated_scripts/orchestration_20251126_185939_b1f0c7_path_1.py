...
async def task_task_1() -> Dict[str, Any]:
    ...
    try:
        ...
        tool_params_search_polymarket_markets = {'query': 'bitcoin prediction 2025', 'session_id': None, 'limit': None}
