...
class TaskMapper:
    ...
    def map_task(self, task: Dict[str, Any]) -> Tuple[Optional[str], Dict[str, Any]]:
        ...
        suggested_agent = task.get('agent', '').lower().replace('-', '_')
    ...
    def _extract_params(self, task_desc: str, agent_name: str) -> Dict[str, Any]:
        ...
        if agent_name == "market_data_agent":
            ...
            params = self._extract_reasoning_params(task_desc)
    ...
    def _extract_polymarket_params(self, task_desc: str) -> Dict[str, Any]:
        """Extract parameters for polymarket_agent."""
        params = {
            "query": task_desc,
    ...
    def _extract_reasoning_params(self, task_desc: str) -> Dict[str, Any]:
        """Extract parameters for reasoning_agent."""
        params = {
            "query": task_desc,
            "session_id": None  # Will be auto-generated
        }
