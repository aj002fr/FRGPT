...
async def task_task_2() -> Dict[str, Any]:
    ...
    logger.info(f"Starting task {task_id}: Retrieve Polymarket prediction data for Bitcoin...")
    ...
    try:
        ...
        tool_params_search_polymarket_markets = {'query': 'Bitcoin', 'session_id': '20220101_000000_abc123', 'limit': None}
        ...
        tool_params_get_polymarket_history = {'session_id': '20220101_000000_abc123', 'limit': None}
