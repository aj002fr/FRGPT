...
# Configuration
RUN_ID = "20251126_162039_84b18a"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve the prediction for Bitcoin price in 2025 from Polymarket
    Agent: polymarket_agent
    """
    task_id = "task_1"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve the prediction for Bitcoin price in 2025 ...")
