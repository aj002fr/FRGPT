...
async def task_task_1() -> Dict[str, Any]:
    ...
    logger.info(f"Starting task {task_id}: Retrieve Bitcoin prediction market data from Polym...")
    ...
    try:
        ...
        tool_params_search_polymarket_markets = {'query': 'Bitcoin', 'session_id': None, 'limit': None}
