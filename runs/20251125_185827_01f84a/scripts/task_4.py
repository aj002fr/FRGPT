...
async def task_task_3() -> Dict[str, Any]:
    """
    Task task_3: Fetch historical price series for Bitcoin
    Agent: market_data_agent
    """
    task_id = "task_3"
    agent_name = "market_data_agent"
    
    logger.info(f"Starting task {task_id}: Fetch historical price series for Bitcoin...")
    ...
    try:
        ...
        output_path = agent.run(template="by_symbol", params={'symbol_pattern': '%BTC%'}, columns=None, limit=1000, order_by_column="price", order_by_direction="ASC")
