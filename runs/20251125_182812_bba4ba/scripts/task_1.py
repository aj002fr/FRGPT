...
# Configuration
RUN_ID = "20251125_182812_bba4ba"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Search prediction markets for: bitcoin prediction 2025
    Agent: polymarket_agent
    """
    task_id = "task_1"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Search prediction markets for: bitcoin prediction ...")
    ...
    try:
        ...
        output_path = agent.run(query="search prediction markets for: bitcoin prediction 2025", session_id=None, limit=10)
