...
async def task_task_2() -> Dict[str, Any]:
    ...
    try:
        ...
        tool_params_search_polymarket_with_history = {'query': 'Bitcoin price 2025', 'limit': None, 'session_id': None}
