...
# Configuration
RUN_ID = "20251125_200920_6ca3bb"
DB_PATH = Path("Z:\Aastha\market_data_puller\workspace\orchestrator_results.db")


async def task_task_1() -> Dict[str, Any]:
    """
    Task task_1: Retrieve the current prediction data for Bitcoin in 2025 from Polymarket
    Agent: polymarket_agent
    """
    task_id = "task_1"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Retrieve the current prediction data for Bitcoin i...")
    ...
    try:
        ...
        output_path = agent.run(query="retrieve the current prediction data for bitcoin in 2025 from polymarket", session_id=None, limit=10)
...
async def task_task_2() -> Dict[str, Any]:
    """
    Task task_2: Fetch the historical prediction data for Bitcoin from Polymarket
    Agent: polymarket_agent
    """
    task_id = "task_2"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Fetch the historical prediction data for Bitcoin f...")
    ...
    try:
        # Execute agent
        agent = PolymarketAgent()
        output_path = agent.run(query="fetch the historical prediction data for bitcoin from polymarket", session_id=None, limit=10)
...
async def task_task_3() -> Dict[str, Any]:
    """
    Task task_3: Analyze the trend of the prediction data
    Agent: polymarket_agent
    """
    task_id = "task_3"
    agent_name = "polymarket_agent"
    
    logger.info(f"Starting task {task_id}: Analyze the trend of the prediction data...")
    ...
    try:
        # Execute agent
        agent = PolymarketAgent()
        output_path = agent.run(query="analyze the trend of the prediction data", session_id=None, limit=10)
