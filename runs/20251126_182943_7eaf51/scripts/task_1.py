...
async def task_task_1() -> Dict[str, Any]:
    ...
    logger.info(f"Starting task {task_id}: Search for: test query...")
    ...
    try:
        ...
        tool_params_search_polymarket_markets = {'query': 'search for: test query', 'session_id': None, 'limit': 10}
