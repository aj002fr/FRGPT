...
async def task_task_1() -> Dict[str, Any]:
    ...
    try:
        ...
        output_path = agent.run(query="retrieve polymarket data for bitcoin prediction in 2025", session_id=None, limit=10)
